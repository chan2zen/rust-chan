...
```
FRAC_X:=TDXDLL2(1, HIGH, LOW, 1);
FRAC:IF(FRAC_X=-100 OR FRAC_X=-1 OR FRAC_X=-200, -1, IF(FRAC_X=1 OR FRAC_X=100 OR FRAC_X=200, 1, 0)); {笔极点}
DUAN:IF(FRAC_X=-100, -1, IF(FRAC_X=100, 1, 0)); {段极点}
...
BIZG_ORIG:=TDXDLL2(2, HIGH, LOW, 2);
BIZD_ORIG:=TDXDLL2(2, HIGH, LOW, 3);
BIZG:ABS(BIZG_ORIG);
BIZD:ABS(BIZD_ORIG);
...
DRAWLINE(DUAN1=-1,ZEN2.POLE_VALUE,ZEN2.TIP=1, ZEN2.POLE_VALUE,0), LINETHICK2, COLORFF8000, CIRCLEDOT;
DRAWLINE(DUAN1=1,ZEN2.POLE_VALUE,ZEN2.TIP=-1, ZEN2.POLE_VALUE,0), LINETHICK2, COLORFF8000, CIRCLEDOT;
